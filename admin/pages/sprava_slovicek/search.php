...
<div class="w3-bar w3-gray">
  ...
  <div class="w3-dropdown-hover w3-gray">
    <div class="w3-bar-item w3-button w3-padding-16" style="padding-bottom: 14px !important; padding-left: 14px !important;padding-right: 14px !important;"><i class="material-icons">add</i>
  ...
  <div class="w3-bar-item" id="searchDIV">
    <input type="search" name="search" id="search" style="color:black;"><img src="../../../images/icons/clear-24px.svg" alt="clear" height="18" id="clear-input"></img>
  </div>
  <!--zmena jazyka-->  
    <a id="japan_czech" class="w3-bar-item w3-button w3-padding-16" style="padding-right:16px !important;padding-left:16px !important;">JP</a>
  <!--Filter--> 
  <button id="filter_button" onclick="myFunction('Demo1')" class="w3-button w3-bar-item w3-padding-16" style=""><i class="fas fa-filter"></i></button>
  <!--odhlaseni--> 
...
<div id="Demo1" class="w3-container w3-hide" style="background-color:#F5F5F5">
  ...
  <p>
    <label class="container" style="margin-top:12px">Slovicka
      <input type="checkbox" checked="checked" class="TechniquesWordsOnClick inputfile filter_box" id="TechniquesWordsOnClickSlovicka" />
  ...
  Typy technik:
  <div class="w3-row">
      <button id="filter_button1" onclick="myFunction('Demo2')" class="w3-button w3-col w3-rest"><i class="fas fa-caret-down"></i></i></button>
  </div>
      ...
      <div class="w3-bar">
        <form id="add_new_word">
          <div class="w3-bar">
            ...
            <input type="text" name="japanese" id="japanese" class="input_css">
          </div>
          <div class="w3-bar" style="margin-top:16px;">
            <label>Česky:</label>
            <div class="w3-bar"></div>
            <input type="text" name="czech" id="czech" class="input_css">
          </div>
          <div class="w3-bar-item">
          <!--<button id="edit-pridavani" class="odkaz" style="display: none;">Slovíčko už existuje, můžete ho upravit</button>-->
            <a class="modal-trigger zkouska odkaz" id="edit-pridavani" href="#modal1" data-id="" style="display: none;">Slovíčko už existuje, můžete ho upravit</a>
          </div>
      </div>
      <div class="w3-bar">
        <label for="add-continue" class="w3-button w3-item-bar"style="margin:16px; margin-left:0px"><i class="material-icons icons-button">send</i>Přidat a pokračovat v přidávání</label>
        <input type="submit" name="submit" id="add-continue" class="inputfile-1 inputfile">
        </form>
        <button id="add-close" class="w3-bar-item w3-button" style="margin:16px; margin-left:0px;padding: 8px 13px!important;"><i class="material-icons icons-button">subdirectory_arrow_right</i>Přidat a zavřít</button>
      </div>
    </div>
  </div>
  ...
  <div id="modal3" class="modal">
    ...
    <div class="modal-content edit-typu">
      ...
      <form id="add_new_type">
        ...
        <div class="w3-bar">
        <div class="w3-bar-item">
            <input type="text" name="type" id="type" class="input_css" placeholder="Lorem ipsum...">
        </div>
        <div class="w3-bar-item">
          <label for="Pridat" class="w3-button w3-item-bar"><i class="material-icons icons-button">add</i>Přidat</label>
    ...
    <div class="modal-content">
      ...
      <form id="add_new_technique">
        <div class="w3-bar">
          <div class="w3-bar-item">
          <!--<button id="edit-pridavani" class="odkaz" style="display: none;">Slovíčko už existuje, můžete ho upravit</button>-->
            <a class="waves-effect waves-light   modal-trigger zkouska odkaz" id="edit-pridavani" href="#modal1" data-id="" style="display: none;">Slovíčko už existuje, můžete ho upravit</a>
          </div>
          <div class="w3-bar">
            <label>Japonsky:</label>
          </div>
          <div class="w3-bar">
            <input type="text" name="japanese" id="japanese-technique" class="input_css">
          </div>
          <div class="w3-bar" style="margin-top:16px;">
            <label>Česky:</label>
          </div>
          <div class="w3-bar">
            <input type="text" name="czech" id="czech-technique" class="input_css">
          </div>
        </div>
        <div class="w3-bar" style="margin-top:16px;">
        ...
        <div class="w3-bar">
          <div class="w3-bar-item">
            <label for="add-close-technique" class="w3-button"><i class="material-icons icons-button">subdirectory_arrow_right</i>Přidat a zavřít</label>
          ...
          <div class="w3-bar-item">
            <label for="add-continue-technique" class="w3-button"><i class="material-icons icons-button">send</i>Přidat a pokračovat v přidávání</label>
